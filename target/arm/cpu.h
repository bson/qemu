...
/* V7M DEMCR bits */
FIELD(V7M_DEMCR, VC_CORERESET, 0, 1)
FIELD(V7M_DEMCR, VC_MMERR, 4, 1)
FIELD(V7M_DEMCR, VC_NOCPERR, 5, 1)
FIELD(V7M_DEMCR, VC_CHKERR, 6, 1)
FIELD(V7M_DEMCR, VC_STATERR, 7, 1)
FIELD(V7M_DEMCR, VC_BUSERR, 8, 1)
FIELD(V7M_DEMCR, VC_INTERR, 9, 1)
FIELD(V7M_DEMCR, VC_HARDERR, 10, 1)
FIELD(V7M_DEMCR, MON_EN, 16, 1)
FIELD(V7M_DEMCR, MON_PEND, 17, 1)
FIELD(V7M_DEMCR, MON_STEP, 18, 1)
FIELD(V7M_DEMCR, MON_REQ, 19, 1)
FIELD(V7M_DEMCR, TRCENA, 24, 1)

/* V7M DHCSR bits (only the fields we give any meaning to) */
FIELD(V7M_DHCSR, C_DEBUGEN, 0, 1)
FIELD(V7M_DHCSR, C_HALT, 1, 1)
FIELD(V7M_DHCSR, C_STEP, 2, 1)
FIELD(V7M_DHCSR, C_MASKINTS, 3, 1)
FIELD(V7M_DHCSR, S_REGRDY, 16, 1)
FIELD(V7M_DHCSR, S_HALT, 17, 1)
FIELD(V7M_DHCSR, S_SLEEP, 18, 1)
FIELD(V7M_DHCSR, S_LOCKUP, 19, 1)
FIELD(V7M_DHCSR, S_RETIRE_ST, 24, 1)
FIELD(V7M_DHCSR, S_RESET_ST, 25, 1)
FIELD(V7M_DHCSR, DBGKEY, 16, 16)
